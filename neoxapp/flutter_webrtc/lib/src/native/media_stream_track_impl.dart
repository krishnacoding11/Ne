...
class MediaStreamTrackNative extends MediaStreamTrack {
  MediaStreamTrackNative(this._trackId, this._label, this._kind, this._enabled, this._peerConnectionId, [this.settings_ = const {}]);

  factory MediaStreamTrackNative.fromMap(Map<dynamic, dynamic> map, String peerConnectionId) {
    return MediaStreamTrackNative(map['id'], map['label'], map['kind'], map['enabled'], peerConnectionId, map['settings'] ?? {});
  }
  ...
  set enabled(bool enabled) {
    WebRTC.invokeMethod('mediaStreamTrackSetEnable', <String, dynamic>{'trackId': _trackId, 'enabled': enabled, 'peerConnectionId': _peerConnectionId});
    _enabled = enabled;
  ...
  Future<ByteBuffer> captureFrame() async {
    ...
    await WebRTC.invokeMethod(
      'captureFrame',
      <String, dynamic>{'trackId': _trackId, 'peerConnectionId': _peerConnectionId, 'path': '${filePath.path}/captureFrame.png'},
    );
