...
class MediaDeviceNative extends MediaDevices {
  ...
  Future<List<MediaDeviceInfo>> enumerateDevices() async {
    ...
    return source
        .map(
          (e) => MediaDeviceInfo(deviceId: e['deviceId'], groupId: e['groupId'], kind: e['kind'], label: e['label']),
        )
        .toList();
  }

  @override
  Future<MediaDeviceInfo> selectAudioOutput([AudioOutputOptions? options]) async {
