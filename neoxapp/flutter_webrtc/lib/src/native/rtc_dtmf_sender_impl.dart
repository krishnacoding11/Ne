...
class RTCDTMFSenderNative extends RTCDTMFSender {
  ...
  @override
  Future<void> insertDTMF(String tones, {int duration = 100, int interToneGap = 70}) async {
  ...
  Future<bool> canInsertDtmf() async {
    return await WebRTC.invokeMethod('canInsertDtmf', <String, dynamic>{'peerConnectionId': _peerConnectionId, 'rtpSenderId': _rtpSenderId});
  }
}
