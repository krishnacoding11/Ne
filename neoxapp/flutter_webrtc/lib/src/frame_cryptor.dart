...
import 'native/frame_cryptor_impl.dart' if (dart.library.html) 'web/frame_cryptor_impl.dart';
...
class KeyProviderOptions {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (uncryptedMagicBytes != null) 'uncryptedMagicBytes': uncryptedMagicBytes,
...
abstract class FrameCryptor {
  ...
  Function(String participantId, FrameCryptorState state)? onFrameCryptorStateChanged;
