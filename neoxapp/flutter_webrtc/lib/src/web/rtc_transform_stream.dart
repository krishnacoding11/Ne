...
extension PropsRTCTransformEvent on RTCTransformEvent {
  RTCRtpScriptTransformer get transformer => js_util.getProperty(this, 'transformer');
}
...
extension PropsRTCRtpScriptTransformer on RTCRtpScriptTransformer {
  ...
  Future<int> generateKeyFrame([String? rid]) => js_util.promiseToFuture(js_util.callMethod(this, 'generateKeyFrame', [rid]));

  Future<void> sendKeyFrameRequest() => js_util.promiseToFuture(js_util.callMethod(this, 'sendKeyFrameRequest', []));
...
class RTCRtpScriptTransform {
  external factory RTCRtpScriptTransform(Worker worker, [dynamic options, Iterable<dynamic>? transfer]);
}
