...
class GrammarParser {
  ...
  static final List<List<int>> _transitions37 = [
    [33, 33, 36, 43, 45, 58, 65, 91, 93, 93, 95, 95, 97, 107, 110, 115, 118, 122, 126, 126],
    [108, 108],
    [109, 109],
    [116, 116],
    [117, 117]
  ...
  static final List<List<int>> _transitions38 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 114, 118, 122, 126, 126],
    [83, 115],
    [84, 116],
    [85, 117]
  ];
  ...
  static final List<List<int>> _transitions39 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 104, 106, 111, 113, 122, 126, 126],
    [73, 105],
    [80, 112]
  ];
  ...
  static final List<List<int>> _transitions43 = [
    [33, 33, 36, 37, 39, 43, 45, 58, 63, 63, 65, 91, 93, 93, 95, 95, 97, 122, 126, 126]
  ];
  ...
  static final List<List<int>> _transitions46 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 82, 84, 90, 95, 122, 126, 126],
    [83, 83]
  ];
  ...
  static final List<List<int>> _transitions57 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 68, 72, 74, 77, 80, 81, 84, 90, 95, 122, 126, 126],
    [65, 65],
    [66, 66],
    [67, 67],
    [73, 73],
  ...
  static final List<List<int>> _transitions60 = [
    [0, 32, 34, 36, 38, 38, 40, 41, 44, 44, 47, 47, 58, 64, 91, 94, 123, 125, 127, 1114111],
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 122, 126, 126]
  ];

  static final List<List<int>> _transitions61 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 100, 102, 112, 114, 122, 126, 126],
    [101, 101],
    [113, 113]
  ];

  static final List<List<int>> _transitions62 = [
    [0, 32, 34, 36, 38, 38, 40, 41, 44, 44, 47, 47, 58, 64, 92, 94, 123, 125, 127, 1114111],
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 122, 126, 126],
    [91, 91]
  ];

  static final List<List<int>> _transitions63 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 96, 98, 104, 106, 113, 116, 122, 126, 126],
    [65, 97],
    [73, 105],
    [82, 114],
    [83, 115]
  ...
  static final List<List<int>> _transitions64 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 103, 105, 122, 126, 126],
    [104, 104]
  ];

  static final List<List<int>> _transitions65 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 110, 112, 113, 115, 122, 126, 126],
    [79, 111],
    [82, 114]
  ];

  static final List<List<int>> _transitions66 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 96, 98, 104, 106, 108, 110, 115, 85, 117, 119, 122, 126, 126],
    [65, 97],
    [73, 105],
    [77, 109],
    [84, 116],
  ...
  static final List<List<int>> _transitions67 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 108, 110, 122, 126, 126],
    [77, 109]
  ];
  ...
  static final List<List<int>> _transitions69 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 115, 117, 122, 126, 126],
    [116, 116]
  ];
  ...
  static final List<List<int>> _transitions70 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 67, 69, 90, 95, 122, 126, 126],
    [68, 68]
  ];

  static final List<List<int>> _transitions71 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 96, 98, 99, 101, 109, 112, 112, 116, 122, 126, 126],
    [97, 97],
    [100, 100],
    [110, 110],
    [111, 111],
  ...
  static final List<List<int>> _transitions73 = [
    [0, 32, 34, 36, 38, 38, 40, 41, 44, 44, 47, 47, 58, 64, 91, 94, 123, 125, 127, 1114111],
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 76, 78, 90, 95, 122, 126, 126],
    [77, 109]
  ];

  static final List<List<int>> _transitions74 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 96, 98, 122, 126, 126],
    [65, 97]
  ];
  ...
  static final List<List<int>> _transitions76 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 98, 100, 122, 126, 126],
    [99, 99]
  ];

  static final List<List<int>> _transitions77 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 96, 98, 111, 113, 115, 117, 122, 126, 126],
    [65, 97],
    [80, 112],
    [84, 116]
  ];
  ...
  static final List<List<int>> _transitions78 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 100, 102, 113, 115, 122, 126, 126],
    [101, 101],
    [114, 114]
  ];

  static final List<List<int>> _transitions79 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 99, 101, 102, 72, 104, 106, 109, 79, 111, 81, 113, 83, 115, 117, 122, 126, 126],
    [68, 100],
    [71, 103],
    [73, 105],
    [78, 110],
  ...
  static final List<List<int>> _transitions80 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 97, 99, 108, 110, 113, 115, 115, 117, 122, 126, 126],
    [98, 98],
    [109, 109],
    [114, 114],
    [116, 116]
  ...
  static final List<List<int>> _transitions82 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 82, 86, 90, 95, 122, 126, 126],
    [83, 115],
    [84, 116],
    [85, 117]
  ];
  ...
  static final List<List<int>> _transitions85 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 113, 115, 122, 126, 126],
    [114, 114]
  ];
  ...
  static final List<List<int>> _transitions87 = [
    [33, 33, 37, 37, 39, 39, 42, 43, 45, 46, 48, 57, 65, 90, 95, 100, 103, 115, 117, 122, 126, 126],
    [101, 101],
    [102, 102],
    [116, 116]
  ];
  ...
  String? _matchString(List<int> codePoints, String string, [bool ignoreCase = false]) {
    ...
    if (success) {
      for (var i = 0; i < length; i++) {
        if (ignoreCase) {
          if (String.fromCharCode(codePoints[i]).toLowerCase() != String.fromCharCode(_input[_cursor + i]).toLowerCase()) {
            success = false;
            break;
          }
        } else {
          ...
          case 0:
            while (true) {
              ...
              while (true) {
                $$ = _parse_h16();
                if (!success) break;
                var seq = List<dynamic>.filled(13, null, growable: false)..[0] = $$;
                $$ = _matchChar(58, ':');
                if (!success) break;
                seq[1] = $$;
                $$ = _parse_h16();
              ...
              while (true) {
                $$ = _parse_h16();
                if (!success) break;
                var seq = List<dynamic>.filled(11, null, growable: false)..[0] = $$;
              ...
              while (true) {
                $$ = _parse_h16();
                if (!success) break;
                var seq = List<dynamic>.filled(10, null, growable: false)..[0] = $$;
                var testing0 = _testing;
                _testing = _cursor;
                switch (_ch >= 0 && _ch <= 1114111
                    ? 0
              ...
              while (true) {
                $$ = _parse_h16();
                if (!success) break;
                var seq = List<dynamic>.filled(8, null, growable: false)..[0] = $$;
          ...
          case 1:
            while (true) {
              ...
              while (true) {
                $$ = _matchString(_strings3, '::', false);
                if (!success) break;
                var seq = List<dynamic>.filled(12, null, growable: false)..[0] = $$;
                $$ = _parse_h16();
                if (!success) break;
                seq[1] = $$;
                $$ = _matchChar(58, ':');
        ...
        while (true) {
          ...
          if (success) {
            ...
            $$ = ((offset, param, value) {
              ...
              if (param.toLowerCase() == 'transport') value = value.toLowerCase();
