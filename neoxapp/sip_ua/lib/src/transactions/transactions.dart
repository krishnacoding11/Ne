...
bool checkTransaction(TransactionBag transactions, IncomingRequest request) {
  switch (request.method) {
    case SipMethod.INVITE:
      InviteServerTransaction? tr = transactions.getTransaction(InviteServerTransaction, request.via_branch!);
      if (tr != null) {
        switch (tr.state) {
    ...
    default:
      ...
      NonInviteServerTransaction? tr = transactions.getTransaction(NonInviteServerTransaction, request.via_branch!);
      if (tr != null) {
        switch (tr.state) {
