...
class InviteClientTransaction extends TransactionBase {
  InviteClientTransaction(UA ua, Transport transport, OutgoingRequest request, EventManager eventHandlers) {
  ...
  void sendACK(IncomingMessage response) {
    OutgoingRequest ack = OutgoingRequest(SipMethod.ACK, request.ruri, ua, <String, dynamic>{'route_set': request.getHeaders('route'), 'call_id': request.getHeader('call-id'), 'cseq': request.cseq});
  ...
  void cancel(String? reason) {
    ...
    OutgoingRequest cancel = OutgoingRequest(SipMethod.CANCEL, request.ruri, ua, <String, dynamic>{'route_set': request.getHeaders('route'), 'call_id': request.getHeader('call-id'), 'cseq': request.cseq});
