...
*/
enum SipMethod { ACK, BYE, CANCEL, GET, INFO, INVITE, MESSAGE, NOTIFY, OPTIONS, REGISTER, REFER, UPDATE, SUBSCRIBE }
...
const String ALLOWED_METHODS = 'INVITE,ACK,CANCEL,BYE,UPDATE,MESSAGE,OPTIONS,REFER,INFO,NOTIFY';
