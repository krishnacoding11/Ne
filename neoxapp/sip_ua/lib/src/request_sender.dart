    ...
    */
    if ((status_code == 401 || status_code == 407) && (_ua.configuration.password != null || _ua.configuration.ha1 != null)) {
      ...
      if (!_challenged || (!_staled && challenge.stale == true)) {
        _auth ??= DigestAuthentication(Credentials.fromMap(<String, dynamic>{'username': _ua.configuration.authorization_user, 'password': _ua.configuration.password, 'realm': _ua.configuration.realm, 'ha1': _ua.configuration.ha1}));
