...
// Checks for requests.
const List<bool Function()> requests = <bool Function()>[rfc3261_8_2_2_1, rfc3261_16_3_4, rfc3261_18_3_request, rfc3261_8_2_2_2];

// Checks for responses.
const List<bool Function()> responses = <bool Function()>[rfc3261_8_1_3_3, rfc3261_18_3_response];
...
bool rfc3261_8_1_3_3() {
  if (message.getHeaders('via').length > 1) {
    logger.d('more than one Via header field present in the response, dropping the response');
...
bool rfc3261_18_3_response() {
  ...
  if (len < contentLength) {
    logger.d('message body length is lower than the value in Content-Length header field, dropping the response');
...
bool minimumHeaders() {
  List<String> mandatoryHeaders = <String>['from', 'to', 'call_id', 'cseq', 'via'];

  for (String header in mandatoryHeaders) {
    if (!message.hasHeader(header)) {
      logger.d('missing mandatory header field : $header, dropping the response');
